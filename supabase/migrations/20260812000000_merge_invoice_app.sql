-- ============================================================
-- MIGRASI: Gabungkan aplikasi Invoice ke dalam PCRS
-- (Sekarang bagian dari supabase/migrations/ — dijalankan lewat SQL
-- Editor project Supabase PCRS seperti migrasi lainnya, urut sesuai nama
-- file. JANGAN dijalankan di project Supabase Invoice yang lama.)
--
